    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <ScrollView>
                <View style={{ flex: 1, alignItems: 'center', margin: 10 }}>
                    ...
                    <TextInput
                        ...
                        label={<Text style={{ fontSize: 18, fontWeight: 400 }}>Hotel / Vila / Resorte</Text>}
                        ...
                        right={<TextInput.Icon icon="home-search" />}
                    />
                    ...
                    <TextInput
                        ...
                        activeOutlineColor='#EDDEBE'
                        // onFocus={alert('hi')}
                        label={<Text style={{ fontSize: 18, fontWeight: 600 }}>Check-In Date</Text>}
                    ...
                    <TextInput
                        ...
                        activeOutlineColor='#EDDEBE'
                        // onFocus={alert('hi')}
                        label={<Text style={{ fontSize: 18, fontWeight: 600 }}>Check-Out Date</Text>}
                        onTouchStart={() => toggleDatePicker()}
                        // disabled="true"
                        editable="false"
                        placeholder='Select Date'
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <TextInput
                            ...
                            activeOutlineColor='#EDDEBE'
                            // onFocus={alert('hi')}
                            label={<Text style={{ fontSize: 18, fontWeight: 600 }}>Guests</Text>}
                        ...
                        <TextInput
                            ...
                            activeOutlineColor='#EDDEBE'
                            // onFocus={alert('hi')}
                            label={<Text style={{ fontSize: 18, fontWeight: 600 }}>Rooms</Text>}
            ...
            <View style={{ borderWidth: 1, position: 'absolute', bottom: 0, alignSelf: 'center', justifyContent: 'center', width: '100%', }}>
                ...
                <TouchableOpacity style={[styles.button, { height: 50 }]} onPress={() => { navigation.navigate("HotelSearchResults") }}>
