...
const FlightSearchReturn = (props) => {
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView>
                <View style={{ flex: 1, alignItems: 'center', margin: 10 }}>
                    ...
                    <Octicons name="arrow-switch" color={"#5F615F"} size={15}  />
                    </View>
                    <TextInput
                        mode='flat'
                        outlineColor='#DADADA'
                    ...
                    <TextInput
                        ...
                        activeOutlineColor='#EDDEBE'
                        // onFocus={alert('hi')}
                        label={<Text style={{ fontSize: 18, fontWeight: 600 }}>Departure Date</Text>}
                    ...
                    <TextInput
                        ...
                        activeOutlineColor='#EDDEBE'
                        // onFocus={alert('hi')}
                        label={<Text style={{ fontSize: 18, fontWeight: 600 }}>Return Date</Text>}
                        onTouchStart={() => toggleDatePicker()}
                        // disabled="true"
                        editable="false"
                        placeholder='Select Date'
